...
* ROS Noetic:
  ...
  .. code-block:: shell
     ...
     bash <(curl -Ls https://raw.githubusercontent.com/shadow-robot/aurora/master/bin/run-ansible.sh) docker_deploy --branch master tag=noetic-v1.0.31 product=hand_e nvidia_docker=true reinstall=true sim_icon=true container_name=dexterous_hand_simulated
