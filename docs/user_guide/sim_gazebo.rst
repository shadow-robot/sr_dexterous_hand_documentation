...
* ROS Noetic:
  ...
  .. code-block:: shell
     ...
     bash <(curl -Ls https://raw.githubusercontent.com/shadow-robot/aurora/v2.2.4/bin/run-ansible.sh) docker_deploy --branch v2.2.4 tag=noetic-v1.0.29 product=hand_e nvidia_docker=true reinstall=true sim_icon=true container_name=dexterous_hand_simulated
