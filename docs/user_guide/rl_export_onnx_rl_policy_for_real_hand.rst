...
.. note:: 
    This tool expects the checkpoint file structure to be as-is from the training process. More information on this `can be found here <https://github.com/shadow-robot/sr_hand_control_sandbox/tree/F_vive_reorientation/sr_rl_vive_reorientation#torch_rlgames_export_cfgpy>`_.
